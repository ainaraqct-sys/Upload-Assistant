...
ghcr.io/jycreyn/upload-assistant:latest /downloads/path/to/content --help
```
...
-v /full/path/to/downloads:/downloads \
--entrypoint python \
ghcr.io/jycreyn/upload-assistant:latest /Upload-Assistant/config-generator.py
```
...
-v /full/path/to/config.py:/Upload-Assistant/data/config.py \
-v /full/path/to/downloads:/downloads \
ghcr.io/jycreyn/upload-assistant:abc123 /downloads/path/to/content --help
```
...
function upload(){
        ...
        echo $args
        docker pull ghcr.io/jycreyn/upload-assistant:latest
        eval "docker run --rm -it --network=host -v /full/path/to/config.py:/Upload-Assistant/data/config.py -v /full/path/to/downloads:/downloads -v /full/path/to/BT_backup:/BT_backup ghcr.io/jycreyn/upload-assistant:latest ${args}"
}
```
