...
BDINFO_VERSION = "v1.0.8"  # renovate: datasource=github-releases depName=Audionut/BDInfoCLI-ng
...
def download_bdinfo_for_docker(base_dir: Path = Path("/Upload-Assistant"), version: Optional[str] = None) -> str:
    version = _fetch_latest_github_release("Audionut/BDInfoCLI-ng", BDINFO_VERSION) if version is None else version
