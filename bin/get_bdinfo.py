...
class BDInfoBinaryManager:
    ...
    @staticmethod
    async def ensure_bdinfo_binary(base_dir: Union[str, Path], debug: bool, version: Optional[str] = None) -> str:
        if version is None:
            version = _fetch_latest_github_release("Audionut/BDInfoCLI-ng", BDINFO_VERSION)
