        ...
        if tracker in api_trackers:
            ...
            if upload_status:
                ...
                if is_uploaded and "status_message" in status and "data error" not in str(status["status_message"]):
                    ...
                    cast(dict, meta.get("tracker_status", {})).get(tracker_class.tracker, {})["upload"] = False
            ...
            if upload_status:
                ...
                if is_uploaded:
                    ...
                    cast(dict, meta.get("tracker_status", {})).get("THR", {})["upload"] = False
                    status = cast(StatusDict, meta.get("tracker_status") or {}).get("THR", {})
            ...
            if upload_status:
                try:
                    ...
                    if is_uploaded and "status_message" in status and "data error" not in str(status["status_message"]):
                        ...
                        cast(dict, meta.get("tracker_status", {})).get(ptp.tracker, {})["upload"] = False
